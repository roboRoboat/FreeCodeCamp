...
// total number of graded exam assignments
...
foreach (string name in studentNames)
{
    ...
    // initialize/reset total scores/points
    decimal examScore = 0;
    ...
    // total number of assignments (exams + extra credit)
    ...
    */
    ...
    extraCreditScore = (decimal)(sumExtraCreditScores) / extraCreditAssignments;
    overallGrade = (decimal)(sumAssignmentScores) / examAssignments;
    extraCreditPoints = overallGrade - (decimal)examScore;
    ...
    Console.WriteLine($"{currentStudent}\t\t{examScore}\t\t{overallGrade}\t{currentStudentLetterGrade}\t{extraCreditScore} ({extraCreditPoints} pts)");
}
